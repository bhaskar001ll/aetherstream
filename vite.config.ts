...
const SITE_URL = process.env.VITE_SITE_URL ?? "https://muffin.app/";
...
//   standalone-send     one self-contained muffin-sender.html
//   standalone-receive  one self-contained muffin-receiver.html
//
  ...
  if (standalone) {
    return {
      ...
      plugins: [
        ...
        standaloneCsp(page),
        viteSingleFile(),
        emitAs(outDir, `${page}/index.html`, `muffin-${page === "send" ? "sender" : "receiver"}.html`),
      ],
